...
HomeBanners = {
	images = { "home/banner_volcanicfurniture.png", "home/banner_sinisterarcher.png" },
	delay = 5
}
...
GameStore.Categories = {
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs", "Potions", "Runes", "Food Especial" },
	},
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			{
				icons = { "Exercise_Axe.png" },
				name = "Boosted Exercise Distance",
				price = 42,
				itemtype = 62005,
				charges = 24400,
				description = "<i>Use it to train your distance fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your distance skill\n{info} usable 14400 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Exercise_Axe.png" },
				name = "Boosted Exercise Club",
				price = 42,
				itemtype = 62006,
				charges = 24400,
				description = "<i>Use it to train your club on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your club skill\n{info} usable 14400 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Exercise_Axe.png" },
				name = "Boosted Exercise Wand",
				price = 42,
				itemtype = 62007,
				charges = 24400,
				description = "<i>Use it to train your magic level skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your magic level skill\n{info} usable 14400 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Exercise_Axe.png" },
				name = "Boosted Exercise Shielding",
				price = 42,
				itemtype = 62008,
				charges = 24400,
				description = "<i>Use it to train your shielding skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your shielding skill\n{info} usable 14400 times a piece",
			...
			{
				icons = { "Exercise_Axe.png" },
				name = "Boosted Exercise Sword",
				price = 42,
				itemtype = 62009,
				charges = 24400,
				description = "<i>Use it to train your sword skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your sword fighting skill\n{info} usable 14400 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Exercise_Axe.png" },
				name = "Boosted Exercise Fist",
				price = 42,
				itemtype = 62010,
				charges = 24400,
				description = "<i>Use it to train your fist skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your sword fighting skill\n{info} usable 14400 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Exercise_Bow.png" },
	...
	-- Consumables ~ Runes
	{
		...
		offers = {

			{
				...
				itemtype = 9086,
				count = 1,
				description = "Enche toda sua mana.",
			...
			},
			{
				...
				itemtype = 20310,
				count = 1,
				description = "Nao compre food nunca mais!.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 29414,
				count = 1,
				description = "Ele ira regenerar 30% da sua vida maxima no atual level.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 9087,
				count = 1,
				description = "Aumenta 10 pontos de Distance Fighting por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 29409,
				count = 1,
				description = "Aumenta 7 pontos de Distance Fighting por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 29412,
				count = 1,
				description = "Você fica 80 pontos mais rapido por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 11584,
				count = 1,
				description = "Aumenta a sua velocidade embaixo d'água enquanto usar um Helmet of the Deep ou Depth Galea por 24 horas.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 29415,
				count = 1,
				description = "Ele irá regenerar 30% da sua mana maxima no atual level..",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 29411,
				count = 1,
				description = "Aumenta 3 pontos de Axe Fighting, Club Fighting e Sword Fighting por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 11587,
				count = 1,
				description = "Possui varios efeitos aleatórios.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 9085,
				count = 1,
				description = "Faz você ficar realmente rapido (+100) por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 9080,
				count = 1,
				description = "Ira curar voce de todas as condicoes negativas e nocivas.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
			...
			},
			{
				...
				itemtype = 9088,
				count = 1,
				description = "Aumenta 50 pontos de Fishing Skill por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 11586,
				count = 1,
				description = "Ele irá curar 5 000 de sua vida.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 9081,
				count = 1,
				description = "Aumenta 10 pontos de Shielding Skill por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 29408,
				count = 1,
				description = "Aumenta 7 pontos de Shielding Skill por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 9079,
				count = 1,
				description = "Enche toda sua vida.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
			...
			},
			{
				...
				itemtype = 29413,
				count = 1,
				description = "Aumenta 30 pontos de Fishing Skill por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 11588,
				count = 1,
				description = "Cria dez cópias do anel que você está usando.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 9082,
				count = 1,
				description = "Aumenta 5 pontos de Magic Level por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 29410,
				count = 1,
				description = "Aumenta 3 pontos de Magic Level por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Animate_Dead_Rune.png" },
				...
				itemtype = 9084,
				count = 1,
				description = "Aumenta 10 pontos de Axe Fighting, Club Fighting e Sword Fighting por uma hora.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
	},
	...
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
			...
			-- TAGS DAS 37 MONTARIAS FALTANTES NO GAMESTORE.LUA

			{
				...
				price = 200,
				id = 44,
				description = "{character}\n{speedboost}\n\n<i>Thousands of years ago, its ancestors ruled the world. Only recently, it found its way into Tibia. The Azudocus is a majestic creature that combines the strength of ancient beasts with the loyalty of a faithful companion.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Battle_Werewolf.png" },
				name = "Battle Werewolf",
				price = 200,
				id = 245,
				description = "{character}\n{speedboost}\n\n<i>Born from the darkest nights and fiercest battles, the Battle Werewolf is a fearsome companion that combines the cunning of a wolf with the strength of a warrior. Its howl strikes fear into the hearts of enemies while inspiring courage in its rider.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Bumblebee.png" },
				...
				price = 200,
				id = 231,
				description = "{character}\n{speedboost}\n\n<i>The Bumblebee is a delightful flying companion that brings the joy of spring wherever it goes. With its cheerful buzzing and colorful stripes, this mount will make you the center of attention while providing swift and reliable transportation.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 229,
				description = "{character}\n{speedboost}\n\n<i>From the deepest swamps emerges the Bog Tyrant, a fearsome predator that has adapted to thrive in the most hostile environments. Its powerful jaws and armored hide make it an intimidating presence on any battlefield.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 45,
				description = "{character}\n{speedboost}\n\n<i>Thousands of years ago, its ancestors ruled the world. Only recently, it found its way into Tibia. The Carpacosaurus is a heavily armored dinosaur that provides excellent protection for its rider during dangerous expeditions.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 240,
				description = "{character}\n{speedboost}\n\n<i>Rising from the ashes of death itself, the Corpse Phoenix is a magnificent yet terrifying sight. This undead bird of legend carries the power of rebirth and destruction, making it a perfect companion for those who walk the line between life and death.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 230,
				description = "{character}\n{speedboost}\n\n<i>The Crimson Fang is a predator of unmatched ferocity, with fangs that gleam like rubies in the moonlight. Its crimson coat and piercing eyes make it a mount that commands respect and fear in equal measure.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 250,
				id = 216,
				description = "{character}\n{speedboost}\n\n<i>Born from the depths of the underworld, the Darkfire Devourer feeds on shadows and flame. This demonic mount brings with it the power of darkness, making it the perfect companion for those who embrace the darker arts.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 241,
				description = "{character}\n{speedboost}\n\n<i>The Death Phoenix represents the final stage of the phoenix cycle, where death and rebirth become one. This magnificent creature carries the wisdom of ages and the power to transcend mortality itself.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 219,
				description = "{character}\n{speedboost}\n\n<i>The Doom Skull is a harbinger of fate, carrying with it the weight of destiny. Its hollow eyes see through the veil of time, making it a mount for those who dare to face their darkest fears.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 111,
				description = "{character}\n{speedboost}\n\n<i>Thousands of years ago, its ancestors ruled the world. Only recently, it found its way into Tibia. The Ember Saurian carries the heat of ancient volcanoes, its scales glowing like burning coals.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 191,
				description = "{character}\n{speedboost}\n\n<i>The origins of the Emerald Raven, Mystic Raven, and Radiant Raven are shrouded in darkness, as no written record nor tale told by even the most knowing storytellers mentions but a trace of them. The Emerald Raven shines with the brilliance of precious gems.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 300,
				id = 178,
				description = "{character}\n{speedboost}\n\n<i>The Festive Mammoth, Holiday Mammoth and Merry Mammoth are gentle giants with a massive appearance and impressive tusks, whose mission it is to deliver gifts all across Tibia. They are good-natured beings, spreading joy wherever they go.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Foxmouse.png" },
				...
				price = 200,
				id = 218,
				description = "{character}\n{speedboost}\n\n<i>The Foxmouse is a curious hybrid creature that combines the cunning of a fox with the agility of a mouse. This playful mount brings joy and mischief wherever it goes, making every journey an adventure.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 228,
				description = "{character}\n{speedboost}\n\n<i>From the frozen peaks of the highest mountains comes the Glacier Wyrm, a dragon of ice and snow. Its breath can freeze the very air, and its scales shimmer like crystalline ice in the sunlight.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 194,
				description = "{character}\n{speedboost}\n\n<i>The Gloothomotive is a marvel of Glooth engineering, combining the power of steam with the mystical properties of Glooth. This mechanical mount represents the pinnacle of Rathleton's technological achievements.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Gloomwurm.png" },
				...
				price = 200,
				id = 190,
				description = "{character}\n{speedboost}\n\n<i>The Bogwurm, Gloomwurm, and Rustwurm belong to a little known subset of the dragon family, and usually live out their lives in habitats far away from human interaction. The Gloomwurm dwells in the darkest corners of the world.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 300,
				id = 223,
				description = "{character}\n{speedboost}\n\n<i>The Gorgon Hydra is a legendary creature of immense power, with multiple heads that can strike fear into the hearts of even the bravest warriors. Its serpentine nature and deadly gaze make it a mount for only the most courageous riders.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 250,
				id = 224,
				description = "{character}\n{speedboost}\n\n<i>The Dawnbringer Pegasus heralds the coming of a new day with its radiant wings and noble bearing. This celestial mount carries the light of dawn wherever it flies, bringing hope and renewal to all who witness its passage.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 300,
				id = 177,
				description = "{character}\n{speedboost}\n\n<i>The Festive Mammoth, Holiday Mammoth and Merry Mammoth are gentle giants with a massive appearance and impressive tusks, whose mission it is to deliver gifts all across Tibia. The Holiday Mammoth brings festive cheer to every celebration.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 237,
				description = "{character}\n{speedboost}\n\n<i>The Leaf Locust is a master of camouflage, blending seamlessly with the forest foliage. This nature-loving mount brings the tranquility of the woods wherever it travels, making it perfect for those who seek harmony with nature.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 220,
				description = "{character}\n{speedboost}\n\n<i>Forged in the fires of the deepest volcanoes, the Magma Skull burns with eternal flame. This fiery mount brings the power of molten rock and blazing heat to those brave enough to ride it.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 176,
				description = "{character}\n{speedboost}\n\n<i>The Festive Mammoth, Holiday Mammoth and Merry Mammoth are gentle giants with a massive appearance and impressive tusks, whose mission it is to deliver gifts all across Tibia. The Merry Mammoth spreads joy and laughter wherever it goes.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 236,
				description = "{character}\n{speedboost}\n\n<i>The Night Locust emerges when darkness falls, its wings creating a haunting melody as it flies. This nocturnal mount is perfect for those who prefer to travel under the cover of night.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 233,
				description = "{character}\n{speedboost}\n\n<i>The Pallbearer is a solemn mount that carries the weight of eternity on its shoulders. This dignified creature serves as a bridge between the world of the living and the realm of the dead.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 238,
				description = "{character}\n{speedboost}\n\n<i>The Pearl Locust shimmers with an iridescent beauty that captures the light like precious pearls. This elegant mount brings grace and refinement to every journey, making its rider stand out in any crowd.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 37,
				description = "{character}\n{speedboost}\n\n<i>Thousands of years ago, its ancestors ruled the world. Only recently, it found its way into Tibia. The Platesaurian is heavily armored with natural plates that provide excellent protection for both mount and rider.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 150,
				id = 239,
				description = "{character}\n{speedboost}\n\n<i>The Satin Moth is a creature of ethereal beauty, with wings that shimmer like the finest silk. This graceful mount brings elegance and mystique to every flight, making it a favorite among those who appreciate refined beauty.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 250,
				id = 226,
				description = "{character}\n{speedboost}\n\n<i>The Skybreaker Pegasus soars through the heavens with unmatched power, its wings capable of breaking through the very clouds themselves. This mighty mount represents the ultimate freedom of flight.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 242,
				description = "{character}\n{speedboost}\n\n<i>The Soul Phoenix embodies the eternal spirit that transcends death and rebirth. This magnificent creature carries within it the essence of all souls, making it a mount of profound spiritual significance.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 320,
				id = 217,
				description = "{character}\n{speedboost}\n\n<i>The Spirit of Purity is a divine mount that radiates with holy light and celestial grace. This sacred creature brings blessing and protection to its rider, serving as a beacon of hope in the darkest times.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 221,
				description = "{character}\n{speedboost}\n\n<i>The Corpsefire Skull burns with the flames of the underworld, its hollow sockets glowing with supernatural fire. This necromantic mount is perfect for those who command the powers of death and decay.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 250,
				id = 225,
				description = "{character}\n{speedboost}\n\n<i>The Wrathfire Pegasus burns with righteous fury, its mane and wings ablaze with divine fire. This powerful mount channels the wrath of the heavens, making it a fearsome ally in battle.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 213,
				description = "{character}\n{speedboost}\n\n<i>The Boisterous Bull is a powerful and energetic mount that charges through life with unstoppable enthusiasm. Its strength and determination make it an excellent companion for those who face challenges head-on.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 215,
				description = "{character}\n{speedboost}\n\n<i>The Obstinate Ox is a stubborn but reliable mount that never gives up, no matter how difficult the path ahead. Its unwavering determination and steady pace make it perfect for long journeys.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 200,
				id = 214,
				description = "{character}\n{speedboost}\n\n<i>The Surly Steer may have a gruff exterior, but beneath its tough demeanor lies a loyal heart. This dependable mount will stand by its rider through thick and thin, never backing down from a fight.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Arctic_Unicorn.png" },
				...
				price = 250,
				id = 114,
				description = "{character}\n{speedboost}\n\n<i>The Arctic Unicorn lives in a deep rivalry with its cousin the Blazing Unicorn. Even though they were born in completely different areas, they somehow share the same bloodline. The eternal battle between fire and ice continues. Who will win? Crystal blue vs. tangerine! The choice is yours!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
	...
	-- Cosmetics ~ Outfits (base outfit has addon = 0 or no defined addon. By default addon is set to 0)
	{
		...
		-- TAGS DOS 13 OUTFITS FALTANTES NO GAMESTORE.LUA

			{
				icons = { "Outfit_Bat_Knight_Male_Addon_3.png", "Outfit_Bat_Knight_Female_Addon_3.png" },
				name = "Full Bat Knight Outfit",
				price = 185,
				sexId = { female = 1875, male = 1874 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Emerging from the shadows of the night, the Bat Knight is a fearsome warrior who has mastered the art of darkness. With wings that cut through the air and armor forged in the depths of ancient caves, this knight brings terror to enemies and protection to allies under the cover of darkness.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Blade_Dancer_Male_Addon_3.png", "Outfit_Blade_Dancer_Female_Addon_3.png" },
				name = "Full Blade Dancer Outfit",
				price = 150,
				sexId = { female = 1746, male = 1745 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Blade Dancer moves with the grace of wind and strikes with the precision of lightning. Every movement is a deadly dance, every step a calculated strike. Their blades sing through the air as they weave between enemies, leaving destruction in their wake while maintaining perfect elegance.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Beekeeper_Male_Addon_3.png", "Outfit_Beekeeper_Female_Addon_3.png" },
				name = "Full Beekeeper Outfit",
				price = 140,
				sexId = { female = 1777, male = 1776 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Beekeeper tends to their buzzing companions with care and dedication. Protected by their specialized gear, they work in harmony with nature's most industrious creatures. Their sweet rewards come from understanding the delicate balance between cultivation and conservation.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Doom_Knight_Male_Addon_3.png", "Outfit_Doom_Knight_Female_Addon_3.png" },
				name = "Full Doom Knight Outfit",
				price = 175,
				sexId = { female = 1714, male = 1713 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Forged in the fires of apocalypse and tempered by endless battles, the Doom Knight stands as harbinger of the end times. Their dark armor pulses with malevolent energy, and their presence alone is enough to make the bravest warriors question their resolve.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Field_Surgeon_Male_Addon_3.png", "Outfit_Field_Surgeon_Female_Addon_3.png" },
				name = "Full Field Surgeon Outfit",
				price = 140,
				sexId = { female = 1815, male = 1814 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Field Surgeon brings hope to the battlefield, healing wounds and saving lives under the most dangerous conditions. Their steady hands and calm demeanor provide comfort to the wounded while their medical expertise turns the tide of battle through preservation of life.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Flamefury Mage channels the raw power of elemental fire, their robes crackling with barely contained energy. Masters of destruction and renewal, they understand that from ashes comes new life, and their flames burn away weakness to reveal inner strength.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Formal_Dress_Male_Addon_3.png", "Outfit_Formal_Dress_Female_Addon_3.png" },
				name = "Full Formal Dress Outfit",
				price = 175,
				sexId = { female = 1461, male = 1460 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Elegance and sophistication define the Formal Dress outfit, perfect for grand occasions and royal gatherings. Whether attending a noble's wedding or a diplomatic reception, this refined attire ensures you make the perfect impression in high society.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Martial Artist has achieved perfect harmony between mind, body, and spirit. Through years of disciplined training, they have learned to channel their inner energy into devastating attacks while maintaining complete control over their emotions and actions.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Necromancer walks the thin line between life and death, commanding the forces of the undead with ancient knowledge and forbidden rituals. Their dark arts allow them to commune with spirits and bend the will of the deceased to serve their purposes.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Retro_Summoner_Male_Addon_3.png", "Outfit_Retro_Summoner_Female_Addon_3.png" },
				name = "Full Retro Summoner Outfit",
				price = 150,
				sexId = { female = 965, male = 964 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Remember the golden days when summoning creatures was an art form? The Retro Summoner outfit brings back the classic style of the old masters, complete with traditional robes and mystical accessories that made summoners legendary.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Retro_Warrior_Male_Addon_3.png", "Outfit_Retro_Warrior_Female_Addon_3.png" },
				name = "Full Retro Warrior Outfit",
				price = 150,
				sexId = { female = 963, male = 962 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Honor the legendary warriors of old with the Retro Warrior outfit. This classic armor design represents the timeless courage and strength that defined the greatest fighters in Tibian history, when battles were won through skill and determination alone.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Royal Costume embodies the majesty and grandeur of true nobility. Crafted with the finest materials and adorned with precious gems, this regal attire is fit for kings and queens who command respect through both presence and authority.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Winged Druid has transcended the earthly bonds that tie most nature-lovers to the ground. With ethereal wings that shimmer with natural magic, they soar above the forests they protect, watching over all living creatures from their aerial domain.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
		...
		--FIM
			...
			{
				icons = { "Outfit_Celestial_Avenger_Male_Addon_3.png", "Outfit_Celestial_Avenger_Female_Addon_3.png" },
				name = "Full Celestial Avenger Outfit",
				price = 185,
				sexId = { female = 1726, male = 1725 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Clad in radiant armor and blessed with divine wings, the Celestial Avenger embodies both justice and fury. Swift as the light and relentless in battle, they strike down their foes with unyielding resolve. Their presence alone inspires allies and unsettles enemies, for they are the very embodiment of celestial judgment, bringing retribution from the skies.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},			
			...
			-- {
				-- icons = { "Outfit_Alternative_Male_Addon_3.png", "Outfit_Alternative_Female_Addon_3.png" },
				-- name = "Especial Outfit",
				-- price = 240,
				-- sexId = { female = 2503, male = 2504 },
				-- addon = 3,
				-- description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armoured Archers are the epitome of invisible danger. Silently and nimbly, they advance in the background. For hours, they wait patiently, almost motionless, for the decisive moment. Just to be perfectly present in a deadly second.</i>",
				-- type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			-- },
			-- {
				-- icons = { "Outfit_Premium_Outfit_Male_Addon_3.png", "Outfit_Premium_Outfit_Female_Addon_3.png" },
				-- name = "Premium Outfit",
				-- price = 400,
	...
	-- House
	{
		...
		name = "Houses",
		rookgaard = true,
		subclasses = { "Decorations", "Chests", "Furniture", "Upgrades", "Hirelings", "Hirelings Dresses" },
	},
	-- House ~ Decorations
	{
		...
		offers = {
			{
				...
				itemtype = 61706,
				count = 1,
				description = "Bau de house para Druids com 60 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 61708,
				count = 1,
				description = "Bau de house para Knights com 60 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 61710,
				count = 1,
				description = "Bau de house para Sorcerer com 60 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 61712,
				count = 1,
				description = "Bau de house para Paladins com 60 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 61743,
				count = 1,
				description = "Bau de house Possessed com 60 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 61924,
				count = 1,
				description = "Bau de house Podium com 60 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 61926,
				count = 1,
				description = "Bau de house Sanguine com 60 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 62035,
				count = 1,
				description = "Bau de house Terra com 30 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 62037,
				count = 1,
				description = "Bau de house Celestial com 30 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 62039,
				count = 1,
				description = "Bau de house Golden com 30 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 62041,
				count = 1,
				description = "Bau de house Electron com 30 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				...
				itemtype = 63363,
				count = 1,
				description = "Bau de house Magic com 120 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
	...
	-- House ~ Furniture
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 49824,
				count = 1,
				description = "Use it in your house.",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Artist_Chair.png" },
	...
	-- House ~ Upgrades
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 28561,
				count = 1,
				description = "<i> 120% de performance garantida - 20% acima dos dummies convencionais! Treine em casa e evolua mais rápido!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
...

			{
				...
				itemtype = 62192,
				count = 1,
				description = "<i> 160% de performance garantida - 60% acima dos dummies convencionais! Treine em casa e evolua mais rápido!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
				home = true,
			},			
...
-- Extras
	{
		...
		name = "Extras",
		rookgaard = true,
		subclasses = { "Extra Services", "Useful Things", "Familiars" },
	},
 ...
 {   
   ...
   offers = {       
            {
                icons = {"none.png"},
                name = "Familiars Sorcerrers",
                parent = "Familiars",
                price = 150,
                itemtype = 35592,
                count = 1,
                description = "De use e ganhe um novo Familiar.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM
            },
            {
                icons = {"none.png"},
                name = "Familiars Druids",
                parent = "Familiars",
                price = 150,
                itemtype = 35591,
                count = 1,
	...
	-- Tournament
	{
		...
		name = "Tournament",
		rookgaard = true,
		subclasses = { "Potions Drome", "Exclusive Offers", "Goldens Replicas", "Dolls & Fansite", "Custom", "Backpacks" },
	},
	-- Tournament ~ Potions Drome
	{
		...
		offers = {
			{
				icons = { "none.png" },
				name = "Physical Resiliences",
				price = 5,
				itemtype = 36735,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily increases physical 1 hour protection",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Death Resiliences",
				price = 5,
				itemtype = 36734,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily increases death 1 hour protection",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Holy Resiliences",
				price = 5,
				itemtype = 36733,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily increases holy 1 hour protection",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Energy Resiliences",
				price = 5,
				itemtype = 36732,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily increases energy 1 hour protection",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Earth Resiliences",
				price = 5,
				itemtype = 36731,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily increases earth 1 hour protection",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Ice Resiliences",
				price = 5,
				itemtype = 36730,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily increases ice 1 hour protection",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Fire Resiliences",
				price = 5,
				itemtype = 36729,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily increases fire 1 hour protection",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Fire Amplifications",
				price = 5,
				itemtype = 36736,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily amplifies 1 hour fire damage against monsters",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "none.png" },
				name = "Ice Amplifications",
				price = 5,
				itemtype = 36737,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily amplifies 1 hour ice damage against monsters",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
						{
				icons = { "none.png" },
				name = "Earth Amplifications",
				price = 5,
				itemtype = 36738,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily amplifies 1 hour earth damage against monsters",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
						{
				icons = { "none.png" },
				name = "Energy Amplifications",
				price = 5,
				itemtype = 36739,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily amplifies 1 hour energy damage against monsters",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
						{
				icons = { "none.png" },
				name = "Holy Amplifications",
				price = 5,
				itemtype = 36740,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily amplifies 1 hour holy damage against monsters",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
						{
				icons = { "none.png" },
				name = "Death Amplifications",
				price = 5,
				itemtype = 36741,
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily amplifies 1 hour holy death against monsters",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
									{
				icons = { "none.png" },
				...
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily amplifies 1 hour holy physical against monsters",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
									{
				icons = { "none.png" },
				...
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily doubles the loot 1 hour from every regular monster you kill",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
									{
				icons = { "none.png" },
				...
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily  1 hour increases critical hit chance",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
									{
				icons = { "none.png" },
				...
				movable = true,
				count = 1,
				description = "Drinking this potion temporarily resets cooldowns for all spells",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
	},
        ...
        offers = { 
             {
			   ...
			   movable = true,
               count = 1,
               description = "This is a golden replica of the famous blessed shield \n\n ",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             },
             {
               icons = { "none.png" },
			   ...
			   movable = true,
               count = 1,
               description = "This is a golden replica of the famous crown",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             },		  
             {
               icons = { "none.png" },
			   ...
			   movable = true,
               count = 1,
               description = "This is a golden replica of the famous horned helmet",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             }, 
             {
              icons = { "none.png" },
			  ...
			  movable = true,
              count = 1,
              description = "This is a golden replica of the famous magic longsword",
              type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
            {
              icons = { "none.png" },
            ...
            }, 
            {
			  ...
			  movable = true,
              count = 1,
              description = "You see green demon armor.\n\n You hear an evil whispering from inside. \n\n Classification: 4 Tier: 0",
              type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
            {
              icons = { "none.png" },
			  ...
			  movable = true,
              count = 1,
              description = "You see green demon legs.\n\n You hear an evil whispering from inside.",
              type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
               icons = { "none.png" },
			   ...
			   movable = true,
               count = 1,
               description = "Souvenir from Thais Museum. \n\n Replica update 13.16",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             },
          ...
          offers = { 
               {
				...
				movable = true,
                count = 1,
                description = "If you use it wisely, you may write yourself into the history books. It was awarded by Erig.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			{
               icons = { "none.png" },
               ...
               {
                icons = { "none.png" },
                name = "Doll of Durin The Almighty",
                price = 30,
                itemtype = 23679,
				movable = true,
                count = 1,
              ...
              },
               {
				...
				movable = true,
                count = 1,
                description = "It represents two different dimensions of Tibia. Are you a Charlover? Or a killer? Anything is possible. Entrusted by TibiaDuality.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
               {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "She fights injustice with kindness in any kingdom, glowing with her light and knowledge throughout all of Tibia. Awarded by TibiaTales.com. ",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
               {
                icons = { "none.png" },
...

               {
				...
				movable = true,
                count = 1,
                description = "It represents the spirit of your first dragon. Granted by Intibia.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
               {
                icons = { "none.png" },
                name = "Aurora's Collection",
                price = 30,
                itemtype = 44759,
				movable = true,
                count = 1,
                description = "Equipped with a magical backpack that never runs out of space, Aurora carries her endless collection on every adventure, eager to show it to everyone along the way. Awarded by TibiaCollection.com ",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "Gods' Twilight Doll",
                price = 20,
                itemtype = 39759,
				movable = true,
                count = 1,
                description = "It represents Valiant on behalf of Fardos and Ragna on behalf of Variphor. It symbolizes the fight between light and darkness, wisdom and ignorance, freedom and domination. Granted by TibiaLight.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			 			  {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "It may be a little too cool to handle. It is entrusted by TibiaFanart.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "It was forged with magical diamonds collected during the journey of a true tibian. Awarded by TibiaLife.com.br",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Only the real killers can touch me! This item was awarded by TibiaBrasileiros.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Baby Brain Squid decoration.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Legends say that when he grew up, he accidentally swallowed his favourite toy. Awarded by Rookie.com.pl.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
              ...
              },
              {
				...
				movable = true,
                count = 1,
                description = "Imbued with the undying soul of the first human, it bestows the might of the gods to its owner. Awarded by TibiArt.net",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
                name = "Bella Bonecrusher's Doll",
                price = 20,
                itemtype = 37054,
				movable = true,
                count = 1,
                description = "In this doll lives the courage and legacy of Bella Bonecrusher. Awarded by Tibiagallery.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
                name = "Black Knight Doll",
                price = 20,
                itemtype = 21435,
				movable = true,
                count = 1,
                description = "My sad story is told by few living humans but many dead warriors",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Eons of wisdom are looking upon thee. Granted by TibiaSecrets.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
                name = "Cateroide's Doll",
                price = 30,
                itemtype = 22151,
				movable = true,
                count = 1,
                description = "A rare doll that only worthy warriors can touch! Awarded by Cateroide.com.br",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              -- {
                -- icons = { "none.png" },
				...
				-- movable = true,
                -- count = 1,
                -- description = "A true champion in the making",
                -- type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              -- },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "This doll carries the story of all Tibians in their legendary citizen outfit. Awarded by TibiaTV.com.br",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "It was frozen deep in the caverns of Folda. A certain warmth and pulse emit from inside. Awarded by TibiaBosses.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Badbara Doll.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
                name = "Dark Wizard's Crown",
                price = 20,
                itemtype = 22153,
				movable = true,
                count = 1,
                description = "It grants infinite power and knowledge to the one who wears it. Awarded by TibiaMisterios.com.br.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
              ...
              },
              {
				...
				movable = true,
                count = 1,
                description = "It is shining with positive energy and was awarded by FunTibia.com.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Omnipotent energies inhabit this place. It is my mission to protect our home. Awarded by TibiaHome.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "It is a token of honour granted only by TibiaBR",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "It rolls over and bares its teeth",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "It knows all secrets of all numbers. It was awarded by the Exhiti.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
              ...
              },
              {
				...
				movable = true,
                count = 1,
                description = "This little fellow has faced many dangers. He will follow you anywhere. Awarded by TibiaGuias",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "This doll possesses an infinite knowledge within. It was rewarded by TibiaTome.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Anyone who drinks this sweet and slightly fizzy drink will fall in love with you immediately. Awarded by CasalTibiano.com.br",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
				...
				movable = true,
                count = 1,
                description = "Gently shrouded in clouds, her dreams are about to come true. As she awakens something magical is about to happen,Granted by TibiaGoals.com",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
              ...
              },
              {
				...
				movable = true,
                count = 1,
                description = "It is said to be a symbol of perseverance and luck. Awarded by TibiaMagazine.com.ve",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              {
                icons = { "none.png" },
          ...
          {   
            ...
            offers = { 
...

			  {
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce podera abrir a exalted forge em qualquer lugar do mapa.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce vai encher todas suas dusts.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				Imovable = true,
                description = "Usando esse item voce vai obter 1 (uma) Hora de XP 100%.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
              },
			  {
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce vai obter 100 pontos de charms.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },

			  {
                icons = { "none.png" },
                name = "Teleport Infinito",
                price = 550,
                itemtype = 49273,
                count = 1,
				movable = true,
                description = "Portal magico pessoal: Teleporte-se para cidades ou sua house!",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Esse item serve para dar upgrade em seu item +1 forge.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce removerá todos seus frag, lembrando que esse item so podera ser usado em area pz.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce tera todas as bless do jogo.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			
			  {
                ...
                count = 1,
				movable = false,
                description = "Com esse item voce podera tentar a sorte em nosso sistema de roullete.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },	
   ...
   {   
     ...
     offers = { 

			  {
                ...
                count = 1,
				movable = true,
                description = "-> Royal backpack/30 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "guildbank backpack",
                price = 30,
                itemtype = 61605,
                count = 1,
				movable = true,
			  ...
			  {
                icons = { "none.png" },
                name = "skeleton backpack",
                price = 30,
                itemtype = 61606,
                count = 1,
				movable = true,
                description = "-> Skeleton backpack/30 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "dukoth backpack",
                price = 20,
                itemtype = 61661,
                count = 1,
				movable = true,
                description = "-> Dukoth backpack/25 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Soul war backpack/45 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Sanguine backpack/55 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Alicorn backpack/45 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Spiritthorn backpack/45 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Arcanomancer backpack/45 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Arboreal backpack/45 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Halloween backpack/55 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Loot Pouch/200 Slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
              },
			  {
                ...
                count = 1,
				movable = true,
                description = "-> Christmas backpack/60 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Voidwalker backpack/60 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Suncrest backpack/60 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "01's birthday backpack",
                price = 35,
                itemtype = 61956,
                count = 1,
				movable = true,
                description = "-> Suncrest backpack/80 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "infernatus backpack",
                price = 35,
                itemtype = 61957,
                count = 1,
				movable = true,
                description = "-> infernatus backpack/80 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "celestius backpack",
                price = 35,
                itemtype = 61958,
                count = 1,
				movable = true,
                description = "-> Celestius backpack/80 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "glacialon backpack",
                price = 35,
                itemtype = 61959,
                count = 1,
				movable = true,
                description = "-> Glacialon backpack/80 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "terramorfo backpack",
                price = 35,
                itemtype = 61960,
                count = 1,
				movable = true,
                description = "-> Terramorfo backpack/80 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "necroshade backpack",
                price = 35,
                itemtype = 61961,
                count = 1,
				movable = true,
                description = "-> Necroshade backpack/80 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "voltagor backpack",
                price = 35,
                itemtype = 61962,
                count = 1,
				movable = true,
                description = "-> Voltagor backpack/80 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "buozzi backpack",
                price = 30,
                itemtype = 61973,
                count = 1,
				movable = true,
                description = "-> Buozzi backpack/30 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "lothlorien backpack",
                price = 31,
                itemtype = 62139,
                count = 1,
				movable = true,
                description = "-> Lothlorien backpack/120 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "executioner backpack",
                price = 40,
                itemtype = 62140,
                count = 1,
				movable = true,
                description = "-> Executioner backpack/60 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "morgul's backpack",
                price = 70,
                itemtype = 62141,
                count = 1,
				movable = true,
                description = "-> Morgul's backpack/90 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Corrupted backpack/90 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "n'zoth backpack",
                price = 70,
                itemtype = 62143,
                count = 1,
				movable = true,
                description = "-> Z'zoth backpack/90 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Hollowstalker backpack/90 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "chillspirit backpack",
                price = 28,
                itemtype = 62303,
                count = 1,
				movable = true,
                description = "-> Chillspirit backpack/90 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "instagram backpack",
                price = 35,
                itemtype = 62623,
                count = 1,
				movable = true,
                description = "-> Instagram backpack/90 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                name = "social backpack",
                price = 35,
                itemtype = 62622,
                count = 1,
				movable = true,
                description = "-> Social backpack/90 slots.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
