...
void IOWheel::initializeMonkConvictionPerkAugmented() {
	...
	m_wheelBonusData.convictionPerkAugmented.monk[2].grade[2].increase.aditionalTarget = 1;
	...
	m_wheelBonusData.convictionPerkAugmented.monk[3].grade[2].increase.damage = 12;
