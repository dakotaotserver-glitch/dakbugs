...
enum WeaponProficiencyPerkType_t : uint16_t {
	...
	PROFICIENCY_PERK_SKILLID_BONUS = 3, // testado e ok
	PROFICIENCY_PERK_SPECIAL_MAGIC_LEVEL = 4, // testado e ok
	PROFICIENCY_PERK_AUGMENT_TYPE = 5, // ok (falta 1)
	PROFICIENCY_PERK_BESTIARY_DAMAGE = 6, // testado e ok
	PROFICIENCY_PERK_DAMAGE_GAIN_BOSS_AND_SINISTER_EMBRACED = 7, // testado e ok
	PROFICIENCY_PERK_CRITICAL_HIT_CHANCE = 8, // testado e ok
	PROFICIENCY_PERK_CRITICAL_HIT_CHANCE_FOR_ELEMENT_ID_SPELLS_AND_RUNES = 9, // testado e ok
	PROFICIENCY_PERK_CRITICAL_HIT_CHANCE_FOR_OFFENSIVE_RUNES = 10, // testado e ok
	PROFICIENCY_PERK_CRITICAL_HIT_CHANCE_FOR_AUTOATTACK = 11, // testado e ok
	PROFICIENCY_PERK_CRITICAL_EXTRA_DAMAGE = 12, // testado e ok
	PROFICIENCY_PERK_CRITICAL_EXTRA_DAMAGE_FOR_ELEMENT_ID_SPELLS_AND_RUNES = 13, // testado e ok
	PROFICIENCY_PERK_CRITICAL_EXTRA_DAMAGE_FOR_OFFENSIVE_RUNES = 14, // testado e ok
	PROFICIENCY_PERK_CRITICAL_EXTRA_DAMAGE_FOR_AUTOATTACK = 15, // testado e ok
	PROFICIENCY_PERK_MANA_LEECH = 16, // testado e ok
	PROFICIENCY_PERK_LIFE_LEECH = 17, // testado e ok
	PROFICIENCY_PERK_MANA_GAIN_ONHIT = 18,
	PROFICIENCY_PERK_LIFE_GAIN_ONHIT = 19,
	PROFICIENCY_PERK_MANA_GAIN_ONKILL = 20, // testado e ok
	PROFICIENCY_PERK_LIFE_GAIN_ONKILL = 21, // testado e ok
