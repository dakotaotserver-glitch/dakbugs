local config = {
	...
	{ position = { x = 33574, y = 32222, z = 7 }, destination = { x = 33338, y = 32124, z = 7 } }, -- Feyrist > Candia
	{ position = { x = 33575, y = 32222, z = 7 }, destination = { x = 33339, y = 32124, z = 7 } }, -- Feyrist > Candia
}
