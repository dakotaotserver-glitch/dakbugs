...
local config = {
    ...
    [43901] = { 
    NAME = "Foxmouse",                 -- Nome do monstro exatamente igual ao do mapa/script!
    ID = 218,                          -- ID da montaria conforme mounts.xml
    BREAK = false,                     -- Não perde o item ao tentar (opcional)
    TYPE = TYPE_MONSTER,               -- Montaria domada em monstro
    CHANCE = 100,                      -- 100% de chance!
    FAIL_MSG = {},                     -- Nunca falha, pode deixar vazio
    SUCCESS_MSG = "You have tamed the Foxmouse.",
    ACHIEV = "Like Fox and Mouse"      -- Achievement ao domar!
},
