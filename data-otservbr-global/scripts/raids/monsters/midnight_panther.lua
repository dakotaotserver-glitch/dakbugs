...
local raid = Raid("tiquanda.midnight-panther", {
	...
	minActivePlayers = 1,
	initialChance = 0.5,
	targetChancePerDay = 0.09,
	maxChancePerCheck = 0.9,
})

raid:addBroadcast("Rumors say that black paw prints have appeared in the deep mud of Tiquanda. Who dares to investigate?"):autoAdvance("30s")
