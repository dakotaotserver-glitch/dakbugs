...
local storageReward = 65084 -- Storage que o jogador recebe ao usar todos os itens
...
function useAction.onUse(player, item, fromPosition, target, toPosition)
    ...
    if table.contains(actionIds, itemActionId) then
        ...
        player:say("Nivel " .. itemsUsed .. " de 5 radiacoes, faltam " .. (5 - itemsUsed) .. " para entrar no covil de Chagorz.", TALKTYPE_MONSTER_SAY)
...
useAction:aid(33112, 33113, 33114, 33115, 33116)
useAction:register()
