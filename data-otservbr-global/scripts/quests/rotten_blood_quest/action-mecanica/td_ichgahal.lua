...
local positionWithStorage = Position(32975, 32330, 15) -- Posição para quem tem a storage 65079
local actionId = 33104 -- Action ID que será verificado ao usar o item
