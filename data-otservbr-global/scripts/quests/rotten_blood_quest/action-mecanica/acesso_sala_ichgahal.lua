local actionIds = {33098, 33099, 33100, 33101, 33102, 33103} -- Lista de Action IDs válidos
local storageIdBase = 65081 -- Storage base para rastrear o uso de cada Action ID
local storageReward = 65082 -- Storage que o jogador recebe ao usar todos os itens
...
function useAction.onUse(player, item, fromPosition, target, toPosition)
    ...
    if table.contains(actionIds, itemActionId) then
        ...
        player:say("Nivel " .. itemsUsed .. " de 6 contaminacoes, faltam " ..
            (6 - itemsUsed) .. " para entrar no covil de Ichgahal.", TALKTYPE_MONSTER_SAY)
...
useAction:aid(33098, 33099, 33100, 33101, 33102, 33103)
useAction:register()
