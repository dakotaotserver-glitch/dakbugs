...
function heartBossDeath.onDeath(creature)
    ...
    elseif monsterName == "world devourer" then
        ...
        setStorageDevourer()
        clearDevourer()
        -- Aqui começa o timer para teleportar os players após 1 minuto!
        teleportPlayersAfterDelay(
            { x = 32260, y = 31336, z = 14 }, -- upCorner da sala
            { x = 32283, y = 31360, z = 14 }, -- downCorner da sala
            120*1000, -- delay de 1 minuto (em ms)
            Position(32214, 31376, 14)  -- posição final de teleporte
        )
    end
    return true
end
