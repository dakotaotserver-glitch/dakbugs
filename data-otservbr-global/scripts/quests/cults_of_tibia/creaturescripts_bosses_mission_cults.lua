local bosses = {
	...
	--["the sandking"] = { storage = Storage.Quest.U11_40.CultsOfTibia.Life.Mission, value = 9, global = "sandking", g_value = 5 },
	["the sandking"] = { storage = Storage.Quest.U11_40.CultsOfTibia.Life.Mission, value = 9 },
