local config = {
	[1] = {
		...
		destination = Position({x = 33372, y = 32241, z = 9}),
		bossPosition = Position({x = 33371, y = 32228, z = 9}),
		specPos = {
			from = Position({x = 33369, y = 32216, z = 9}),
			to = Position({x = 33371, y = 32244, z = 9}),
		},
		exitPosition = Position({x = 33397, y = 32201, z = 9}),
	},
}
