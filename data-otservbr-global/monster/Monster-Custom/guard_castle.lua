...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "Aqui voce nao passa!", yell = false}
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -200, maxDamage = -380, range = 6, radius = 8, shootEffect = 27, effect = 48, target = true },
}
