...
monster.loot = {
	...
	{ name = "small ruby", chance = 3100, maxCount = 4 },
	{ id = 817, chance = 1250 }, -- magma amulet
	{ name = "werecrocodile tongue", chance = 10800 },
	{ name = "sun brooch", chance = 1500 },
	{ name = "golden sun coin", chance = 1100 },
	{ name = "closed pocket sundial", chance = 550 },
	{ name = "ornate crossbow", chance = 350 },
