local mType = Game.createMonsterType("Instable Fires")
local monster = {}

monster.description = "a instable fires"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -45, maxDamage = -560, range = 7, radius = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
