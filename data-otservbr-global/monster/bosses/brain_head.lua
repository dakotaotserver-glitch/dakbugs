...
monster.loot = {
	...
	{ name = "spooky hood", chance = 1500 },
	{ name = "silver hand mirror", chance = 7410 },
	{ name = "amber with a dragonfly", chance = 7410 },
	{ name = "phantasmal axe", chance = 1000 },
	{ name = "ghost claw", chance = 1500 },
	{ name = "giant amethyst", chance = 3700 },
	{ name = "ring of souls", chance = 1000 },
	{ id = 32621, chance = 1000 }, -- ring of souls
}

monster.attacks = {
	{ name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 80, minDamage = -1500, maxDamage = -2300, effect = CONST_ME_MORTAREA, shootEffect = CONST_ANI_SUDDENDEATH, target = true, range = 7 },
	{ name = "combat", type = COMBAT_LIFEDRAIN, interval = 2000, chance = 20, length = 8, spread = 0, minDamage = -1500, maxDamage = -2100, effect = CONST_ME_ELECTRICALSPARK },
}
