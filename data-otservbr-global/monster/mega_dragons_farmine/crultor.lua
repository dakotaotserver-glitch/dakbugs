...
monster.attacks = {
	...
	{ name = "combat", interval = 2500, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -350, maxDamage = -1000, length = 8, spread = 7, effect = 44, target = false },
	{ name = "combat", interval = 2500, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -300, maxDamage = -1000, range = 7, radius = 4, shootEffect = CONST_ANI_ICE, effect = 42, target = true },
...
monster.heals = {
	{ type = COMBAT_ICEDAMAGE, percent = 1000 },
}
monster.defenses = {
	defense = 86,
	armor = 76,
