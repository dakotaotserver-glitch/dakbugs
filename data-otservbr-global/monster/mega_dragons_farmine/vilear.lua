...
monster.attacks = {
	...
	{ name = "combat", interval = 2500, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -350, maxDamage = -1150, range = 2, effect = CONST_ME_BIG_SCRATCH, target = true },
	...
	{ name = "combat", interval = 3000, chance = 5, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -850, radius = 4, effect = CONST_ME_POFF, target = true },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -500, maxDamage = -1200, range = 8, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -500, maxDamage = -1200, radius = 8, effect = 23, target = false },
...
monster.heals = {
	{ type = COMBAT_ENERGYDAMAGE, percent = 1000 },
}
monster.defenses = {
	defense = 86,
	armor = 76,
