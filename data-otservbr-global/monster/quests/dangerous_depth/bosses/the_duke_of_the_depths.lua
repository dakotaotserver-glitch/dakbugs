...
monster.loot = {
    ...
    { name = "blue crystal shard", chance = 60000, maxCount = 5 },
    { id = 27713, chance = 100000, maxCount = 7 }, -- heavy crystal fragment
    { name = "great mana potion", chance = 64580, maxCount = 18 },
    { name = "great spirit potion", chance = 45830, maxCount = 10 },
    { name = "ultimate health potion", chance = 52080, maxCount = 8 },
    { name = "small amethyst", chance = 25000, maxCount = 12 },
    { name = "small diamond", chance = 20830, maxCount = 12 },
    { name = "small emerald", chance = 10420, maxCount = 12 },
    { name = "small ruby", chance = 14580, maxCount = 12 },
    { name = "small topaz", chance = 10420, maxCount = 12 },
    { name = "wand of inferno", chance = 75000 },
    { name = "stone skin amulet", chance = 100000 },
    { name = "mastermind potion", chance = 100000, maxCount = 2 },
    ...
    { name = "silver token", chance = 16670, maxCount = 2 },
    ...
    { name = "pristine worm head", chance = 5000 },
    { name = "mallet pommel", chance = 2000 },
    { name = "spellweaver's robe", chance = 3000 },
    { name = "magma coat", chance = 3000 },
    { name = "gnome legs", chance = 300 },
    { name = "candle stump", chance = 200 },
    { name = "crude wood planks", chance = 1000 },
    { name = "gnomish footwraps", chance = 2000 }
}
