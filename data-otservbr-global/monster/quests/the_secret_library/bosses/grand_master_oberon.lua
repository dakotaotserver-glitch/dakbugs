...
monster.loot = {
	...
	{ name = "brass shield", chance = 3000, maxCount = 1 },
	{ name = "spatial warp almanac", chance = 1000, maxCount = 1 },
	{ name = "viking helmet", chance = 2300, maxCount = 1 },
	{ name = "falcon battleaxe", chance = 900, maxCount = 1 },
	{ name = "falcon longsword", chance = 900, maxCount = 1 },
	{ name = "falcon sai", chance = 900, maxCount = 1 },
	{ name = "falcon mace", chance = 900, maxCount = 1 },
	{ name = "grant of arms", chance = 900, maxCount = 1 },
	{ name = "falcon bow", chance = 900, maxCount = 1 },
	{ name = "falcon circlet", chance = 900, maxCount = 1 },
	{ name = "falcon coif", chance = 850, maxCount = 1 },
	{ name = "falcon rod", chance = 900, maxCount = 1 },
	{ name = "falcon wand", chance = 900, maxCount = 1 },
	{ name = "falcon shield", chance = 800, maxCount = 1 },
	{ name = "falcon greaves", chance = 700, maxCount = 1 },
	{ name = "falcon plate", chance = 800, maxCount = 1 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1800 },
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_HOLYDAMAGE, minDamage = -800, maxDamage = -1400, length = 8, effect = CONST_ME_HOLYAREA, target = false },
	{ name = "combat", interval = 4250, chance = 35, type = COMBAT_EARTHDAMAGE, minDamage = -500, maxDamage = -1200, radius = 5, effect = CONST_ME_HITAREA, target = false },
	{ name = "combat", interval = 5000, chance = 37, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -1200, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false },
}
