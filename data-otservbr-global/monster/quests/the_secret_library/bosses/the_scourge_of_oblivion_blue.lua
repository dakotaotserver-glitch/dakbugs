local mType = Game.createMonsterType("The Scourge of Oblivion Blue")
local monster = {}

monster.description = "The Scourge Of Oblivion Blue"
...
monster.summon = {
	maxSummons = 4,
	summons = {
		{ name = "Imp Intruder", chance = 15, interval = 2000, count = 1 },
		{ name = "Invading Demon", chance = 15, interval = 2000, count = 1 },
		{ name = "Ravenous Beyondling", chance = 15, interval = 2000, count = 1 },
		{ name = "Rift Breacher", chance = 15, interval = 2000, count = 1 },
		{ name = "Rift Minion", chance = 15, interval = 2000, count = 1 },
		{ name = "Rift Spawn", chance = 15, interval = 2000, count = 1 },
		{ name = "Yalahari Despoiler", chance = 15, interval = 2000, count = 1 },
	},
}
...
monster.loot = {
	...
	{ name = "calamity", chance = 1000, unique = true },
	{ name = "spark sphere", chance = 100000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 200, attack = 350 },
