local mType = Game.createMonsterType("Emptys")
local monster = {}

monster.description = "a emptys"
...
monster.attacks = {
{ name = "combat", interval = 2000, chance = 50, type = COMBAT_DEATHDAMAGE, minDamage = -100, maxDamage = -250, radius = 3, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_SMALLCLOUDS, target = false },
}
