...
monster.loot = {
    { name = "gold coin", chance = 10000, maxCount = 9 },
    { name = "platinum coin", chance = 8000, maxCount = 2 },
    { name = "glooth bag", chance = 5000, maxCount = 3 },
    { name = "slightly rusted armor", chance = 1500 },
    { name = "gold ingot", chance = 2000 },
    { name = "glooth glider tubes and wires", chance = 1000, unique = true },
    { name = "violet crystal shard", chance = 2500 },
    { name = "traditional sai", chance = 500 }
}
