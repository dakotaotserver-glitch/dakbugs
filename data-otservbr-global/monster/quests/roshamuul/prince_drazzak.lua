...
monster.attacks = {
	...
	{ name = "prince drazzak summon", interval = 2000, chance = 10, target = false },
	{ name = "prince drazzak wave", interval = 2000, chance = 10, target = false },
	{ name = "prince drazzak tp", interval = 2000, chance = 10, target = false },
	{ name = "prince drazzak druid", interval = 2000, chance = 10, target = false },
	{ name = "prince drazzak knight", interval = 2000, chance = 10, target = false },
	{ name = "prince drazzak paladin", interval = 2000, chance = 10, target = false },
	{ name = "prince drazzak sorcerer", interval = 2000, chance = 10, target = false },
	{ name = "prince drazzak monk", interval = 2000, chance = 10, target = false },
}
