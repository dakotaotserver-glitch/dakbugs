...
monster.loot = {
	...
	{ id = 35610, chance = 1000 }, -- tentugly's eye
	{ id = 35612, chance = 1000 }, -- tentugly's jaws
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 400, maxDamage = -1000 },
	{ name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 40, minDamage = -500, maxDamage = -1200, range = 5, radius = 4, target = true, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_GHOSTLY_BITE },
	{ name = "energy waveT", interval = 2000, chance = 30, minDamage = 0, maxDamage = -250 },
	{ name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 50, minDamage = -500, maxDamage = -1200, radius = 5, effect = CONST_ME_LOSEENERGY },
}
