...
monster.loot = {
    ...
    { name = "platinum coin", chance = 68299, maxCount = 35 },
    { name = "energy bar", chance = 53000, maxCount = 5 },
	{ id = 281, chance = 10040 }, -- giant shimmering pearl (ajuste o ID se necessário!)
    { name = "small amethyst", chance = 19000, maxCount = 10 },
    ...
    -- Raro
    { name = "blood of the mountain charm", chance = 600 },
    { name = "crystalline armor", chance = 600 },
    { name = "cobra crown", chance = 400 },
	{ id = 50156, chance = 350 }, -- enchanted merudri brooch
    { name = "elven legs", chance = 16000 },
    { name = "elven mail", chance = 3000 },
    { name = "gold token", chance = 1532 },
    { name = "jade hat", chance = 350 },
