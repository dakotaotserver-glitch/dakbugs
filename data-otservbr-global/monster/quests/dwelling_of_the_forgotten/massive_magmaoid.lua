local mType = Game.createMonsterType("Massive Magmaoid")
local monster = {}

monster.description = "a Massive Magmaoid"
...
monster.race = "fire"
monster.corpse = 0 -- charged flame
monster.speed = 175
monster.manaCost = 0
...
monster.attacks = {
	...
	{ name = "combat", interval = 3100, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -900, maxDamage = -1600, length = 5, effect = CONST_ME_SMOKE, target = false },
