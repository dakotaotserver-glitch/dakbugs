local mType = Game.createMonsterType("Magmaoid")
local monster = {}

monster.description = "a Magmaoid"
...
monster.attacks = {
	...
	{ name = "combat", interval = 1000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -250, maxDamage = -1200, range = 7, length = 3, spread = 0, effect = CONST_ME_HITBYFIRE, target = false },
