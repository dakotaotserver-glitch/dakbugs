...
monster.loot = {
    ...
    { name = "ultimate spirit potion", chance = 22490, maxCount = 14 }, -- ADICIONADO
    ...
    { name = "transcendence potion", chance = 18000, maxCount = 7 }, -- ADICIONADO
    ...
    { name = "smoldering eye", chance = 500 }, -- ADICIONADO

    -- Muito Raro
    { name = "alicorn headguard", chance = 250 },
    { name = "alicorn quiver", chance = 250 },
    { name = "alicorn ring", chance = 250 }, -- ADICIONADO
    { name = "arboreal crown", chance = 250 },
    { name = "arboreal tome", chance = 250 },
    { name = "arboreal ring", chance = 250 }, -- ADICIONADO
    { name = "arcanomancer regalia", chance = 250 },
    { name = "arcanomancer folio", chance = 250 },
    { name = "arcanomancer sigil", chance = 250 }, -- ADICIONADO
    { name = "ethereal coned hat", chance = 250 },
    { name = "ethereal ring", chance = 250 }, -- ADICIONADO
    { name = "spiritthorn armor", chance = 250 },
    { name = "spiritthorn helmet", chance = 250 },
    { name = "spiritthorn ring", chance = 250 }, -- ADICIONADO
}
