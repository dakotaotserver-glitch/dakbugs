...
monster.summon = {
	maxSummons = 8,
	summons = {
		{ name = "Pillar Of Dark Energy", chance = 100, interval = 1000, count = 8 },
	},
}
...
monster.attacks = {
	...
	{ name = "largeenergyring2", interval = 4000, chance = 8, minDamage = -3200, maxDamage = -4000, target = false },
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -1500, range = 7, radius = 7, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true },
	...
	{ name = "speed", interval = 2000, chance = 10, speedChange = -300, radius = 5, effect = 20, target = false, duration = 10000 },
	...
	{ name = "combat", interval = 3000, chance = 8, type = COMBAT_ENERGYDAMAGE, minDamage = -2500, maxDamage = -3500, length = 8, spread = 0, effect = CONST_ME_ELECTRICALSPARK, target = false },
}

monster.defenses = {
	defense = 105,
	armor = 105,
	{ name = "combat", interval = 3000, chance = 10, type = COMBAT_HEALING, minDamage = 700, maxDamage = 1500, effect = 14, target = false },
}
