...
monster.summon = {
	maxSummons = 8,
	summons = {
		{ name = "Pillar Of Dark Energy", chance = 100, interval = 500, count = 8 },
	},
}
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -1800, maxDamage = -3050 },
	{ name = "largeenergyring2", interval = 4000, chance = 10, minDamage = -3200, maxDamage = -4000, target = false },
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -1500, range = 7, radius = 7, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -1500, radius = 7, effect = CONST_ME_MORTAREA, target = false },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = -500, maxDamage = -1500, radius = 7, effect = 32, target = false },
	{ name = "speed", interval = 2000, chance = 12, speedChange = -300, radius = 5, effect = 20, target = false, duration = 10000 },
	{ name = "combat", interval = 2000, chance = 8, type = COMBAT_DEATHDAMAGE, minDamage = -2500, maxDamage = -3500, length = 8, spread = 0, effect = CONST_ME_MORTAREA, target = false },
...
monster.defenses = {
	defense = 105,
	armor = 105,
	{ name = "combat", interval = 3000, chance = 10, type = COMBAT_HEALING, minDamage = 800, maxDamage = 1500, effect = 14, target = false },
}
