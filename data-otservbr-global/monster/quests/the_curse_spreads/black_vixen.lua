...
monster.loot = {
	{ name = "gold coin", chance = 13600000, maxCount = 73 },
	...
	{ name = "moonlight crystals", chance = 100, maxCount = 1, event = true },
}
