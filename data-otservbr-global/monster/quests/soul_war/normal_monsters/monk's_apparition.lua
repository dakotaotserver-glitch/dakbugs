...
monster.loot = {
    -- Comum
    { name = "crystal coin", chance = 76000 },

    -- Incomum
    { name = "warrior helmet", chance = 7000 },
    { name = "great spirit potion", chance = 6800 },

    -- Semi-raro
    { name = "glacier amulet", chance = 3800 },
    { name = "glacier mask", chance = 3800 },
    { name = "violet gem", chance = 3800 },
    { name = "green gem", chance = 3800 },
    { name = "blue gem", chance = 3600 },
    { name = "wood cape", chance = 3400 },
    { name = "skull helmet", chance = 3200 },
    { id = 50151, chance = 3200 }, -- ring of orange plasma

    -- Raro
    { name = "stone skin amulet", chance = 1500 },
	{ id = 50152, chance = 700 }, -- collar of orange plasma
    -- Muito raro
