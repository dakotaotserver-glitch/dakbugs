...
monster.loot = {
	...
	{ name = "platinum coin", chance = 40000, maxCount = 8 },
	{ name = "werepanther claw", chance = 3500 },
	{ name = "golden sickle", chance = 5120 },
	{ name = "meat", chance = 5500, maxCount = 2 },
	{ name = "small topaz", chance = 2100, maxCount = 2 },
	{ name = "moonlight crystals", chance = 2550 },
	{ id = 3037, chance = 1900 }, -- yellow gem
	{ name = "lightning headband", chance = 1500 },
	{ name = "ripper lance", chance = 850 },
	{ name = "gemmed figurine", chance = 850 },
	{ id = 816, chance = 1500 }, -- lightning pendant
