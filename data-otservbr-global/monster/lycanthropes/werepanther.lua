...
monster.loot = {
	...
	{ name = "werepanther claw", chance = 7500 },
	{ name = "golden sickle", chance = 6720 },
	{ name = "meat", chance = 5500, maxCount = 2 },
	{ name = "small ruby", chance = 3100, maxCount = 2 },
	{ name = "moonlight crystals", chance = 2550 },
	{ id = 3039, chance = 2100 }, -- red gem
	{ name = "magma monocle", chance = 2150 },
	{ name = "ripper lance", chance = 1250 },
	{ name = "gemmed figurine", chance = 1100 },
	{ id = 817, chance = 1250 }, -- magma amulet
	{ name = "fur armor", chance = 1100 },
	{ id = 43917, chance = 450 }, -- werepanther trophy
}
