...
monster.loot = {
    ...
    { name = "platinum coin", chance = 30000, maxCount = 20 },
    { name = "moonlight crystals", chance = 7000 },
    { name = "weretiger tooth", chance = 13400 },
    { name = "beastslayer axe", chance = 2100 },
    { name = "ham", chance = 5500, maxCount = 2 },
    { name = "white gem", chance = 1650 },
    { name = "silver moon coin", chance = 950 },
    { name = "moon pin", chance = 10 },
    { name = "blue robe", chance = 850 },
    { name = "crystal mace", chance = 350 },
	{ id = 50151, chance = 400 }, -- ring of orange plasma
}
