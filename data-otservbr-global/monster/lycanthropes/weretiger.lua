...
monster.loot = {
	...
	{ name = "platinum coin", chance = 40000, maxCount = 10 },
	{ name = "weretiger tooth", chance = 4300 },
	{ name = "furry club", chance = 3500 },
	{ name = "meat", chance = 3600, maxCount = 4 },
	{ name = "violet crystal shard", chance = 2100 },
	{ name = "moonlight crystals", chance = 2100 },
	{ id = 3041, chance = 350 }, -- blue gem
	{ name = "knight armor", chance = 1100 },
	{ name = "angelic axe", chance = 750 },
	{ name = "silver moon coin", chance = 210 },
	{ id = 43915, chance = 320 }, -- weretiger trophy
}
