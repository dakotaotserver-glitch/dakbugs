...
monster.loot = {
    ...
    { name = "wand of starstorm", chance = 420 }, -- se tiver o id, pode trocar

    -- Muito raro (por nome para evitar conflito de id, como pediu)
    { name = "violet gem", chance = 100 },
    { name = "focus cape", chance = 70 },
    { id = 23531, chance = 50 }, -- ring of green plasma
    { id = 23533, chance = 50 }, -- ring of red plasma
    { id = 23529, chance = 50 }, -- ring of blue plasma
	{ id = 50151, chance = 50 }, -- ring of orange plasma
    { id = 23543, chance = 30 }, -- collar of green plasma
    { id = 23542, chance = 30 }, -- collar of blue plasma
    { id = 23544, chance = 30 }, -- collar of red plasma
	{ id = 50152, chance = 30 }, -- collar of orange plasma
}
