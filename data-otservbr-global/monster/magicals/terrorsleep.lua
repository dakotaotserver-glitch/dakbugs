...
monster.loot = {
    ...
    { id = 5909, chance = 4520 }, -- blue robe (adicione name se quiser)
    { name = "fish fin", chance = 2000 }, -- adicionado
	{ id = 5909, chance = 1600 }, -- ring of orange plasma
    { name = "blue piece of cloth", chance = 1600 }, -- adicionado
    { id = 20029, chance = 1130 }, -- broken dream
    { name = "red piece of cloth", chance = 1130 },
    { name = "cluster of solace", chance = 100 }, -- adicionado
	...
	{ id = 50151, chance = 560 }, -- ring of orange plasma
