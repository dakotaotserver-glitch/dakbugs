...
monster.loot = {
	...
	{ name = "platinum coin", chance = 40590, maxCount = 5 },
...
monster.attacks = {
	...
	{ name = "melee", interval = 2000, chance = 100, minDamage = -180, maxDamage = -250, condition = { type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -25, maxDamage = -40, length = 5000, spread = 3, effect = CONST_ME_SMALLPLANTS, target = true }},
	-- Earth: Melee (100-200)
