if not Quests then
	Quests = {
		...
		[34] = {
			...
			[35] = {
				...
				missions = {
					...
					[2] = {
						name = "The Ancient Sewers",
						storageId = Storage.Quest.U10_50.OramondQuest.TheAncientSewers.Mission,
						missionId = 10361,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Explore the ancient sewers beneath Rathleton and find the entrance to the Glooth Factory.",
						},
					},
					[3] = {
						name = "The Glooth Bandits",
						storageId = Storage.Quest.U10_50.OramondQuest.GloothBandits.Mission,
						missionId = 10362,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Elbert asked you to retrieve 10 Glooth Capsules stolen by the Glooth Bandits. You can find them in the Underground Glooth Factory.",
						},
					},
					[4] = {
						name = "Four Demanding Statues",
						storageId = Storage.Quest.U10_50.OramondQuest.FourDemandingStatues.Mission,
						missionId = 10363,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Find the four statues in Rathleton and fulfill their demands to gain access to the Glooth Factory.",
						},
					},
					[5] = {
						name = "The Mutated Glooth Plague",
						storageId = Storage.Quest.U10_50.OramondQuest.MutatedGloothPlague.Mission,
						missionId = 10364,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Investigate the mutated glooth plague affecting the workers in the Glooth Factory.",
						},
					},
					[6] = {
						name = "The Gloud Ship",
						storageId = Storage.Quest.U10_50.OramondQuest.GloudShip.Mission,
						missionId = 10365,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Help build the Gloud Ship by collecting materials: Strong Cloth, Bottle of Airtight Gloo, and Filled Gas Bag.",
						},
					},
					[7] = {
						name = "Probing",
						storageId = Storage.Quest.U10_50.OramondQuest.Probing.Mission,
						missionId = 10366,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Use the Mono-Detector to find and analyze strange energy sources around Rathleton.",
						},
					},
					[8] = {
						name = "Communication Breakdown",
						storageId = Storage.Quest.U10_50.OramondQuest.CommunicationBreakdown.Mission,
						missionId = 10367,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Repair the communication devices around Rathleton to restore the city's network.",
						},
					},
					[9] = {
						name = "Rathleton Citizen Rank",
						storageId = Storage.Quest.U10_50.OramondQuest.QuestLine,
						missionId = 10368,
						startValue = 1,
						endValue = 4,
						description = function(player)
							local rank = player:getStorageValue(Storage.Quest.U10_50.OramondQuest.QuestLine)
							local rankNames = {
								[1] = "Commoner",
								[2] = "Inhabitant",
								[3] = "Citizen",
							...
							local points = player:getStorageValue(Storage.Quest.U10_50.OramondQuest.VotingPoints)
							if points < 0 then points = 0 end
							
							return string.format("Your current rank in Rathleton is %s. You have accumulated %d voting points.", 
								rankNames[rank] or "Unknown", points)
						end
					},
					[10] = {
						name = "The Powder of the Stars",
						storageId = Storage.Quest.U10_50.OramondQuest.ThePowderOfTheStars.Mission,
						missionId = 10369,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Collect Star Powder from the Glooth Golems in the Underground Glooth Factory.",
						},
					},
					[11] = {
						name = "Tending Gloothworms",
						storageId = Storage.Quest.U10_50.OramondQuest.TendingGloothworms.Mission,
						missionId = 10370,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Help tend to the Gloothworms by calibrating irrigation funnels, filling them, feeding the worms, and raking the area.",
						},
					},
					[12] = {
						name = "Nature's Balance",
						storageId = Storage.Quest.U10_50.OramondQuest.NaturesBalance.Mission,
						missionId = 10371,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Help restore the balance of nature by hunting creatures that threaten Rathleton's ecosystem.",
						},
					},
					[13] = {
						name = "Glooth Capsules",
						storageId = Storage.Quest.U10_50.OramondQuest.GloothCapsules.Mission,
						missionId = 10372,
						startValue = 1,
						endValue = 1,
						states = {
							[1] = "Collect and deliver Glooth Capsules to help with Rathleton's energy needs.",
						},
					},
				},
			},
		...
		[46] = {
			...
			missions = {
				...
				[5] = {
					...
					endValue = 4,
					states = {
						[1] = "Julius pediu que você encontre um Blood Crystal. Pergunte aos habitantes de Yalahar sobre isso.",
						[2] = "Lorietta mencionou que você pode encontrar um Blood Crystal no esconderijo dos cultistas no Magician Quarter.",
						[3] = "Você encontrou o Blood Crystal. Volte para Julius para mostrar sua descoberta.",
						[4] = "Você completou a quinta missão para Julius, encontrando o Blood Crystal."
					}
				},
				[6] = {
					...
					endValue = 3,
					states = {
						[1] = "Julius pediu que você carregue o Blood Crystal com a energia de alguém que perdeu tudo. Encontre A Wandering Soul em Vengoth.",
						[2] = "Você carregou o Blood Crystal com a energia de A Wandering Soul. Volte para Julius.",
						[3] = "Você completou a sexta missão para Julius, carregando o Blood Crystal."
					}
				},
				[7] = {
					...
					endValue = 4,
					states = {
						[1] = "Julius pediu que você e mais 3 jogadores usem os Charged Blood Crystals para acessar o castelo. Encontre os 4 Strange Carvings.",
						[2] = "Você e seu grupo usaram os Charged Blood Crystals e foram teleportados para o castelo.",
						[3] = "Você encontrou o diário de Arthei sobre Boreth. Volte para Julius com esta informação.",
						[4] = "Você completou a sétima missão para Julius, descobrindo informações sobre Boreth."
					}
				},
				[8] = {
					...
					endValue = 3,
					states = {
						[1] = "Julius pediu que você encontre mais informações sobre os irmãos vampiros. Procure por mais páginas do diário no castelo.",
						[2] = "Você encontrou informações sobre Lersatio. Volte para Julius com esta informação.",
						[3] = "Você completou a oitava missão para Julius, descobrindo informações sobre Lersatio."
					}
				},
				[9] = {
					...
					endValue = 3,
					states = {
						[1] = "Julius pediu que você continue explorando o castelo em busca de mais informações sobre os irmãos vampiros.",
						[2] = "Você encontrou informações sobre Marziel. Volte para Julius com esta informação.",
						[3] = "Você completou a nona missão para Julius, descobrindo informações sobre Marziel."
					}
				},
				[10] = {
					...
					endValue = 3,
					states = {
						[1] = "Julius pediu que você encontre a última parte do diário, que contém informações sobre Arthei.",
						[2] = "Você encontrou a última parte do diário, com informações sobre Arthei. Volte para Julius.",
						[3] = "Você completou a décima e última missão para Julius, descobrindo toda a história dos irmãos vampiros. Como recompensa, você ganhou acesso permanente a Vengoth, o Vampiric Crest, o outfit Yalaharian e o Blood Goblet."
					}
		...
		[50] = {
	        ...
	        [51] = {
            name = "Dark Trails",
            startStorageId = Storage.Quest.U10_50.DarkTrails.Mission01,
            startStorageValue = 1,
            missions = {
                [1] = {
                    name = "Strange Occurences",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission01,
                    missionId = 10461,
                    startValue = 1,
                    endValue = 1,
                    description = "Voce foi enviado para investigar ocorrencias estranhas nas cavernas. Fale com os Gloot Brothers para iniciar sua investigacao."
                },
                [2] = {
                    name = "Initial Investigation",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission02,
                    missionId = 10462,
                    startValue = 1,
                    endValue = 1,
                    description = "Os Gloot Brothers pediram que voce investigue as cavernas em busca de pistas sobre as ocorrencias estranhas."
                },
                [3] = {
                    name = "Mysterious Clues",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission03,
                    missionId = 10463,
                    startValue = 1,
                    endValue = 1,
                    description = "Voce encontrou pistas sobre um ritual misterioso. Continue sua investigacao."
                },
                [4] = {
                    name = "The Ritual Site",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission04,
                    missionId = 10464,
                    startValue = 1,
                    endValue = 1,
                    description = "Voce precisa encontrar o local do ritual para investigar o que aconteceu."
                },
                [5] = {
                    name = "Report to the Gloot Brothers",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission05,
                    missionId = 10465,
                    startValue = 1,
                    endValue = 1,
                    description = "Voce encontrou o local do ritual. Reporte suas descobertas aos Gloot Brothers."
                },
                [6] = {
                    name = "The Necrometer",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission06,
                    missionId = 10466,
                    startValue = 1,
                    endValue = 1,
                    description = "Os Gloot Brothers mencionaram um dispositivo chamado Necrometer que pode ajudar em sua investigacao. Encontre-o."
                },
                [7] = {
                    name = "Obtaining the Necrometer",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission07,
                    missionId = 10467,
                    startValue = 1,
                    endValue = 1,
                    description = "Voce precisa obter o Necrometer para continuar sua investigacao."
                },
                [8] = {
                    name = "Using the Necrometer",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission08,
                    missionId = 10468,
                    startValue = 1,
                    endValue = 1,
                    description = "Use o Necrometer para investigar mais a fundo o local do ritual."
                },
                [9] = {
                    name = "Preparing for The Ravager",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission09,
                    missionId = 10469,
                    startValue = 1,
                    endValue = 1,
                    description = "Sua investigacao revelou a presenca de uma criatura poderosa chamada The Ravager. Prepare-se para enfrenta-la."
                },
                [10] = {
                    name = "Access to The Ravager",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission10,
                    missionId = 10470,
                    startValue = 1,
                    endValue = 1,
                    description = "Use o Necrometer para acessar a area onde The Ravager esta localizado."
                },
                [11] = {
                    name = "Defeat The Ravager",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission11,
                    missionId = 10471,
                    startValue = 0,
                    endValue = 1,
                    description = function(player)
                        return player:getStorageValue(Storage.Quest.U10_50.DarkTrails.Mission11) == 1 
                            and "Voce derrotou The Ravager. Continue sua investigacao." 
                            or "Derrote The Ravager para continuar sua investigacao."
                    end
                },
                [12] = {
                    name = "After The Ravager",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission12,
                    missionId = 10472,
                    startValue = 1,
                    endValue = 1,
                    description = "Apos derrotar The Ravager, continue sua investigacao para descobrir mais sobre o que esta acontecendo."
                },
                [13] = {
                    name = "Looking for Quandon",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission13,
                    missionId = 10473,
                    startValue = 1,
                    endValue = 1,
                    description = "Voce precisa encontrar Quandon, que pode ter informacoes importantes sobre o ritual."
                },
                [14] = {
                    name = "Quandon's Fate",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission14,
                    missionId = 10474,
                    startValue = 1,
                    endValue = 2,
                    states = {
                        [1] = "Procure por Quandon nas cavernas.",
                        [2] = "Voce encontrou o corpo de Quandon. Reporte a Sholley sobre o ocorrido."
                    }
                },
                [15] = {
                    name = "Reporting Quandon's Death",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission15,
                    missionId = 10475,
                    startValue = 1,
                    endValue = 1,
                    description = "Reporte a morte de Quandon a Sholley."
                },
                [16] = {
                    name = "Preparing for Death Priest Shargon",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission16,
                    missionId = 10476,
                    startValue = 1,
                    endValue = 1,
                    description = "Sua investigacao revelou que Death Priest Shargon esta por tras dos rituais. Prepare-se para enfrenta-lo."
                },
                [17] = {
                    name = "Access to Death Priest Shargon",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission17,
                    missionId = 10477,
                    startValue = 1,
                    endValue = 1,
                    description = "Encontre o caminho para a camara onde Death Priest Shargon esta realizando seus rituais."
                },
                [18] = {
                    name = "Defeat Death Priest Shargon",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission18,
                    missionId = 10478,
                    startValue = 0,
                    endValue = 1,
                    description = function(player)
                        return player:getStorageValue(Storage.Quest.U10_50.DarkTrails.Mission18) == 1 
                            and "Voce derrotou Death Priest Shargon e interrompeu seus rituais malignos." 
                            or "Derrote Death Priest Shargon para interromper seus rituais malignos."
                    end
                },
                [19] = {
                    name = "Quest Completed",
                    storageId = Storage.Quest.U10_50.DarkTrails.Mission19,
                    missionId = 10479,
                    startValue = 1,
                    endValue = 1,
                    description = "Voce completou a Dark Trails Quest, derrotando Death Priest Shargon e encerrando a corrupcao nas cavernas."
                },
            },
        },
			...
			[52] = {
				name = "Rathleton Quest",
				startStorageId = Storage.Quest.U10_50.OramondQuest.QuestLine,
				startStorageValue = 1,
				endStorageValue = 1, -- Rank Squire (máximo)
				missions = {
					[1] = {
						name = "Commoner Rank",
						storageId = Storage.Quest.U10_50.Rathleton.Rank,
						missionId = 10480,
						startValue = 1,
						endValue = 4,
						description = "Voce alcancou o rank de Commoner em Rathleton. Agora pode votar em atalhos e na lista de desejos para o dungeon. Continue ajudando a cidade para obter mais pontos de votacao."
					},
					[2] = {
						name = "Inhabitant Rank",
						storageId = Storage.Quest.U10_50.OramondQuest.QuestLine,
						missionId = 10481,
						startValue = 2,
						endValue = 2,
						description = "Voce alcancou o rank de Inhabitant em Rathleton. Agora pode votar em bosses e vender itens especificos para Flint. Continue ajudando a cidade para obter mais pontos de votacao."
					},
					[3] = {
						name = "Citizen Rank",
						storageId = Storage.Quest.U10_50.OramondQuest.QuestLine,
						...
						startValue = 3,
						endValue = 3,
						description = "Voce alcancou o rank de Citizen em Rathleton. Agora tem acesso ao Slime Slide, Underground Glooth Factory e rotas de viagem adicionais. Continue ajudando a cidade para obter mais pontos de votacao."
					},
					[4] = {
						name = "Squire Rank",
						storageId = Storage.Quest.U10_50.OramondQuest.QuestLine,
						...
						startValue = 4,
						endValue = 4,
						description = "Voce alcancou o rank de Squire em Rathleton. Agora pode iniciar a Hero of Rathleton Quest."
					},
					[5] = {
						name = "Shortcut Voting",
						storageId = Storage.Quest.U10_50.Rathleton.ShortcutVotes,
						missionId = 10484,
						startValue = 1,
						endValue = 50, -- Alterado para 50 para marcar como concluído após 50 votos
						description = function(player)
							return string.format("Voce ja votou %d vezes em atalhos. Voce pode votar para atalhos em Minotauros, Fungos ou Catacumbas.", player:getStorageValue(Storage.Quest.U10_50.Rathleton.ShortcutVotes))
						end
					},
					[6] = {
						name = "Dungeon Voting",
						storageId = Storage.Quest.U10_50.Rathleton.DungeonVotes,
						missionId = 10485,
						startValue = 1,
						endValue = 50, -- Alterado para 50 para marcar como concluído após 50 votos
						description = function(player)
							return string.format("Voce ja votou %d vezes em dungeons. Voce pode votar para Golems, Minotauros ou Wrath of Evil.", player:getStorageValue(Storage.Quest.U10_50.Rathleton.DungeonVotes))
						end
					},
					[7] = {
						name = "Boss Voting",
						storageId = Storage.Quest.U10_50.Rathleton.BossVotes,
						missionId = 10486,
						startValue = 1,
						endValue = 50, -- Alterado para 50 para marcar como concluído após 50 votos
						description = function(player)
							return string.format("Voce ja votou %d vezes em bosses. Voce pode votar para Bullwark, Lisa ou Glooth Fairy.", player:getStorageValue(Storage.Quest.U10_50.Rathleton.BossVotes))
						end
					},
					[8] = {
						name = "Raid Voting",
						storageId = Storage.Quest.U10_50.Rathleton.RaidVotes,
						missionId = 10487,
						startValue = 1,
						endValue = 50, -- Alterado para 50 para marcar como concluído após 50 votos
						description = function(player)
							return string.format("Voce ja votou %d vezes em raids. Voce pode votar para Minotauros, Criaturas Mecanicas ou Vida Selvagem.", player:getStorageValue(Storage.Quest.U10_50.Rathleton.RaidVotes))
						end
					},
					[9] = {
						name = "Outfit Progress",
						storageId = Storage.Quest.U10_50.Rathleton.OutfitVotingRecord,
						missionId = 10488,
						startValue = 1,
						endValue = 511, -- Valor maximo para todas as opcoes votadas (bit flags)
						description = function(player)
							local votingRecord = player:getStorageValue(Storage.Quest.U10_50.Rathleton.OutfitVotingRecord)
							local count = 0
							for i = 0, 8 do -- 9 opcoes de voto (3 atalhos, 3 dungeons, 3 bosses)
								if bit.band(votingRecord, bit.lshift(1, i)) ~= 0 then
									count = count + 1
								end
							end
							return string.format("Voce votou em %d de 9 opcoes necessarias para os addons do outfit Glooth Engineer.", count)
						end
					}
				}
			},
			...
			[53] = {
			name = "FerumbrasAscension",
			startStorageId = Storage.Quest.U10_90.FerumbrasAscension.QuestLine,
			startStorageValue = 1,
			missions = {
				[1] = {
					name = "Razzagorn",
				...
				-- The Rise of Podzilla Quest
		[54] = {
			name = "The Rise of Podzilla Quest",
			startStorageId = Storage.U13_40.podzilla.QuestLine,
			startStorageValue = 1,
			missions = {
				[1] = {
					name = "Caminho a Podzilla",
					storageId = Storage.U13_40.podzilla.acessopodzilla,
					missionId = 10464,
					startValue = 1,
					endValue = 2,
					states = {
						[1] = "Agora voce tem acesso aos mares do norte, para encontrar a grande planta que se aproxima da costa, fale com o Captain Seahorse sobre Gunther. Va ate esta Planta Misteriosa e descubra seus segredos.",
						[2] = "Para saber mais sobre este Covil Maligno Fale com os Habitantes deste lugar.",
				    },
				},
				
				[2] = {
					name = "Descobrindo os Misterios de Podzilla",
					storageId = Storage.U13_40.podzilla.habitantes,
					missionId = 10465,
					startValue = 1,
					endValue = 4,
					states = {
						[1] = "Pergunte para o Rato Atui sobre os Misterios deste lugar. Fale Hi, Misterios!",
						[2] = "Agora que ja sabe que o maligno Doctor Marrow esta por traz de tudo isso, voce deve se comunicar com os habitantes desse lugar, os quais ainda nao foram corrompidos para saber sobre a nova e mais malefica abominacao criada por este doutor louco. Fale com o Two Lips, fale (hi) (doutor)",
						[3] = "Fale com o irmao de Two Lips, seu nome e Sprout Sentinel, ele te ajudara a saber mais como acessar e matar o abominavel The Rootkraken. pergunte a ele sobre o experimento! fale (hi) (experimento) ",
						[4] = "Agora voce ja sabe onde e como matar o BOSS",
					},
		
				},	
				
				[3] = {
					name = "The Rootkraken fight",
					storageId = Storage.U13_40.podzilla.salaboss,
					missionId = 10466,
					startValue = 1,
					endValue = 3,
					states = {
						[1] = "Va ate o ultimo andar, procure pelo laboratorio improvisado do doutor la encontrara um teleporte, o qual dara acesso a sala onde enfrentara o terrivel e abominavel The Rootkraken, mas lembre se, ele nunca esta sozinho!",
						[2] = "Reporte a mission para o Two Lips! (hi) (mission)",
						[3] = "Parabens voce completou a The Rise of Podzilla Quest!",
		...
		[55] = {
			...
			missions = {
				[1] = {
					...
					endValue = 2,
					states = {
						[1] = "Find the strange grave the bat was talking about. It can't be that far.",
						[2] = "Find the strange grave the bat was talking about. It can't be that far.",
					},
				},
				[2] = {
					...
					endValue = 2,
					states = {
						[1] = "You were sent to investigate a looming threat of some kind of orcish vampire and his offspring. Locate the Norcferatu fortress in Vengoth and find a way to enter it.",
						[2] = "You were sent to investigate a looming threat of some kind of orcish vampire and his offspring. Locate the Norcferatu fortress in Vengoth and find a way to enter it.",
					},
				},
				[3] = {
					...
					endValue = 2,
					states = {
						[1] = "You first have to gain the assistance of the angered spirits of the orcish ancestors. Find the ancient burial cave and find a way to contact and appease them.",
						[2] = "You first have to gain the assistance of the angered spirits of the orcish ancestors. Find the ancient burial cave and find a way to contact and appease them.",
					},
				},
				[4] = {
					name = "Dance of death",
					...
					endValue = 2,
					states = {
						[1] = "Apeease the Norcferatu ancestors by participating in the ancient orcish ritual dance. Dance the dance of the red full moon and gain their approval.",
						[2] = "Apeease the Norcferatu ancestors by participating in the ancient orcish ritual dance. Dance the dance of the red full moon and gain their approval.",
					},
				},
				[5] = {
					name = "The next step",
					...
					endValue = 2,
					states = {
						[1] = "With the ancestor spirits on your side, it's time to learn hat to do next to gain entrance to Vladdrukhs underground lair. Report back to Anaztassja.",
						[2] = "With the ancestor spirits on your side, it's time to learn hat to do next to gain entrance to Vladdrukhs underground lair. Report back to Anaztassja.",
					},
				},
				[6] = {
					name = "Bloodbath",
					...
					endValue = 2,
					states = {
						[1] = "To fool the magic wards of the fortress, you must first befoul yourself. Gain entrance to the bloodbath and let the Norcferatu's tainted blood seep into your flesh.",
						[2] = "To fool the magic wards of the fortress, you must first befoul yourself. Gain entrance to the bloodbath and let the Norcferatu's tainted blood seep into your flesh.",
					},
				},
			},
		},
