...
local function creatureSayCallback(npc, creature, type, message)
	...
	npcHandler:say("These are the missions I can tell you about: {Minotaurs}, {Life}, {MotA}, {Barkless}, {Misguided}, {Orcs}, {Humans}, {FinalBoss}.", npc, creature)
	...
	elseif
		player:getStorageValue(Storage.Quest.U11_40.CultsOfTibia.Minotaurs.Mission) == 5
	...
	elseif config.missions[message:lower()] then
