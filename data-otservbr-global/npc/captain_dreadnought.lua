...
local towns = {
	...
	[TOWNS_LIST.KAZORDOON] = {
		...
		canBeSailed = true,
		isPremium = true,
		message = "So it's Kazordoon, the city you chose as your new home?",
		destination = { x = 32649, y = 31925, z = 11 },
	},
	...
	[TOWNS_LIST.PORT_HOPE] = {
		...
		destination = { x = 32595, y = 32744, z = 7 },
	},
	[TOWNS_LIST.SVARGROND] = {
		...
		canBeSailed = true,
		isPremium = true,
		message = "So it's Svargrond, the oldest of the human kingdoms you chose as your new home?",
		destination = { x = 32213, y = 31132, z = 7 },
	},
	[TOWNS_LIST.THAIS] = {
		name = "Thais",
		about = {
	...
	[TOWNS_LIST.YALAHAR] = {
		...
		canBeSailed = false,
		isPremium = false,
		message = "So it's Yalahar, that you chose as your new home?",
