...
keywordHandler:addKeyword({ "kick" }, StdModule.kick, {
    ...
    destination = { Position(32228, 31386, 7) }
})
...
npcHandler:setMessage(MESSAGE_GREET, "Where are we at the moment? Is this {Svargrond} {okolnir}, {helheim}, {tyrsung}, {camp} ? NO,*HICKS* it's Okolnir! Anyway, where do you want to go?")
