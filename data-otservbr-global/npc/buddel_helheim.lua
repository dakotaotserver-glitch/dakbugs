...
npcHandler:setMessage(MESSAGE_GREET, "Where are we at the moment? Is this {Svargrond} {okolnir}, {helheim}, {tyrsung}, {camp} ? NO,*HICKS* it's Helheim! Anyway, where do you want to go?")
