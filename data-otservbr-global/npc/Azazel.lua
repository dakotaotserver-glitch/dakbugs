...
npcConfig.voices = {
	interval = 15000,
	chance = 20,
	{ text = "Got items to sell? I'm always buying!" }
}
...
local itemsTable = {
	...
	["rings"] = {
		...
		{ itemName = "might ring", clientId = 3048, buy = 7000, sell = 250, count = 20 },
		{ itemName = "ring of healing", clientId = 3098, buy = 2000, sell = 100 },
		{ itemName = "time ring", clientId = 3053, buy = 4000, sell = 100 },
...
["exercise weapons"] = {
  -- Standard Exercise Weapons (500 gp/uso → 250 000 buy)
  { itemName = "exercise rod",          clientId = 28556, buy = 250000,  count = 500 },
  { itemName = "exercise wand",         clientId = 28557, buy = 250000,  count = 500 },
  { itemName = "exercise axe",          clientId = 28553, buy = 250000,  count = 500 },
  { itemName = "exercise bow",          clientId = 28555, buy = 250000,  count = 500 },
  { itemName = "exercise club",         clientId = 28554, buy = 250000,  count = 500 },
  { itemName = "exercise shield",       clientId = 44065, buy = 250000,  count = 500 },
  { itemName = "exercise sword",        clientId = 28552, buy = 250000,  count = 500 },

  -- Durable Exercise Weapons (475 gp/uso → 855 000 buy)
  { itemName = "durable exercise rod",  clientId = 35283, buy = 855000,  count = 1800 },
  { itemName = "durable exercise wand", clientId = 35284, buy = 855000,  count = 1800 },
  { itemName = "durable exercise axe",  clientId = 35280, buy = 855000,  count = 1800 },
  { itemName = "durable exercise bow",  clientId = 35282, buy = 855000,  count = 1800 },
  { itemName = "durable exercise club", clientId = 35281, buy = 855000,  count = 1800 },
  { itemName = "durable exercise shield", clientId = 44066, buy = 855000, count = 1800 },
  { itemName = "durable exercise sword",  clientId = 35279, buy = 855000,  count = 1800 },

  -- Lasting Exercise Weapons (450 gp/uso → 6 480 000 buy)
  { itemName = "lasting exercise rod",  clientId = 35289, buy = 6480000, count = 14400 },
  { itemName = "lasting exercise wand", clientId = 35290, buy = 6480000, count = 14400 },
  { itemName = "lasting exercise axe",  clientId = 35286, buy = 6480000, count = 14400 },
  { itemName = "lasting exercise bow",  clientId = 35288, buy = 6480000, count = 14400 },
  { itemName = "lasting exercise club", clientId = 35287, buy = 6480000, count = 14400 },
  { itemName = "lasting exercise shield", clientId = 44067, buy = 6480000, count = 14400 },
  { itemName = "lasting exercise sword",  clientId = 35285, buy = 6480000, count = 14400 },
},
	...
	{ itemName = "paper plane", clientId = 51419, sell = 480 },
	{ itemName = "book with an hourglass", clientId = 51425, sell = 1450 },
	{ itemName = "paper boat", clientId = 51420, sell = 800 },
	{ itemName = "star ink", clientId = 51422, sell = 1250 },
	{ itemName = "sealing wax", clientId = 51426, sell = 620 },
	{ itemName = "pressed flower", clientId = 51428, sell = 570 },
	{ itemName = "book with a dragon", clientId = 51423, sell = 1800 },
	{ itemName = "torn page", clientId = 51427, sell = 340 },
	{ itemName = "cookbook", clientId = 51424, sell = 870 },	
	...
	{ itemName = "dragon trophy", clientId = 44158, sell = 4000 },
	...
	{ itemName = "weretiger trophy", clientId = 43915, sell = 15000 },
...
-- (Keyhandler, NPC interactions, etc.)

-- [O restante do script permanece idêntico ao anterior]
...
local function greetCallback(npc, creature)
	...
	npcHandler:setMessage(MESSAGE_GREET, "Welcome, |PLAYERNAME|! Interested in trading? Ask me about {trade} or specific categories like {Ammo}, {Food}, {Potions}, {Runes}, {Rings}, or {Exercise weapons}.")
	return true
end
...
local function creatureSayCallback(npc, creature, type, message)
	...
	for categoryName, _ in pairs(itemsTable) do
		if categoryName ~= "buy_items" then
	...
	if categoryTable then
		npcHandler:say("Of course, here are the " .. message:lower() .. " I have available.", npc, player)
		npc:openShopWindowTable(player, categoryTable)
	elseif MsgContains(message, "trade") then
		npcHandler:say("I buy and sell various items. Which category interests you? " .. table.concat(formattedCategoryNames, ", "), npc, player)
	elseif MsgContains(message, "info") then
		npcHandler:say({
			"Welcome to our trading post! We offer a wide range of potions, runes, and special equipment.",
			"Check our inventory by asking about specific categories or general {trade}."
		}, npc, creature)
	end
