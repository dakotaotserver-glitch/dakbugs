...
local config = {
	...
	["gnomish cuirass"] = { itemid = 50276, token = { type = "major", id = 16129, count = 100 } },
}
...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "major") then
		npcHandler:say({
			"For ten major tokens, I can offer you a {gill gugel}, a {gill coat}, {gill legs}, {gnomish cuirass}, a {spellbook} of vigilance, a {prismatic helmet}, a {prismatic armor}, {prismatic legs}, {prismatic boots} or a {prismatic shield} ...",
