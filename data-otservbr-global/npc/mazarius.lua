...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "short") then
		npcHandler:say({
			...
			"Therefore I need you to enter a hellish dimension and acquire the parts of a weapon, the {godbreaker}, powerful enough to stop him once and for all. Are you willing to help me in this dire mission? {demonic essence}",
		}, npc, creature)
	...
	elseif MsgContains(message, "yes") and npcHandler:getTopic(playerId) == 3 then
		if player:removeItem(6499, 30) then
			...
			player:setStorageValue(Storage.Quest.U10_90.FerumbrasAscension.QuestLine, 1)
