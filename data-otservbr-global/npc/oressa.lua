...
local topicTable = {
    ...
    [9] = VOCATION.ID.MONK, -- Adicionado Monk
}
...
local vocationRoomPositions = {
    ...
    [9] = { x = 32064, y = 31884, z = 6 }, -- Monk usa mesma posição do Knight
}
