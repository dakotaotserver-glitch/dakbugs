...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "addon") and not player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.Questline) == 54 then
    ...
    if player:getItemCount(9041) > 0 and player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.Questline) == 54 then
        player:removeItem(9041, 1) -- Remove o vampiric crest
        player:setStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.Questline, 55)
        npcHandler:say("Great! Here, take this yalaharian addon in return.", npc, creature)
...
npcHandler:setMessage(MESSAGE_GREET, "Greetings. {addon} ?")
